...
//              $(this).find('.duibi-sort').hide();
        ...
        initVideoBox: function(videoType, videoRatio, videoURL, videoWebmURL, videoOggURL) {
            ...
            if(videoType == 'embed') {
                videoHTML = '<video id="div_video" class="video-js vjs-default-skin vjs-big-play-centered" controls autoplay preload="auto" width="100%"><source src="' + videoURL + '" type="video/mp4" /><source src="' + videoWebmURL + '" type="video/webm" /><source src="' + videoOggURL + '" type="video/ogg" /></video>';
